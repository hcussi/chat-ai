...
-   **Layout:** The application will have a main title and a three-column layout below it. The left column will contain the chat management features, the center column will contain the chat interface, and the right column will display the usage statistics. Each column will have a title.
...
-   **Styling:** The application will have a light blue, futuristic theme, with a background image. The currently selected chat will have a distinct style to differentiate it from the others.
